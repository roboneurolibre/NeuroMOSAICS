...
from import_data_osf_NeuroMOSAICS import get_data
...
def get_data(is_mat, is_rat, mat, name):
    ...
    """
    if not is_mat:
        raise ValueError("The provided data is not in .mat format.")
